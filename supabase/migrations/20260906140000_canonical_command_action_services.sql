...
-- Canonical management action surface. Existing public wrappers remain compatibility-only;
-- authenticated management writes use stagepulse_command_action.
