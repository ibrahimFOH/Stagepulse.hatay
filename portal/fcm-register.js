...
(() => {
  'use strict';
  const api = { register_notification_device: async (payload = {}) => { window.dispatchEvent(new CustomEvent('stagepulse:push-register-request', { detail: payload })); return false; } };
