...
function css(){if(document.getElementById('sp-admin-jarvis-css'))return;const l=document.createElement('link');l.id='sp-admin-jarvis-css';l.rel='stylesheet';l.href='jarvis/jarvis.css?v=20260908-jarvis7';document.head.appendChild(l)}
