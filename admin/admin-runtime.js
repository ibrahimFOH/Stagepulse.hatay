...
(() => {
  ...
  const tag=document.createElement('script'); tag.src='admin-bundle.js?v=20260902-offerfix5'; tag.async=false; tag.onload=()=>{ if(typeof window.loadView!=='function') fail(); else {window.STAGEPULSE_ADMIN_READY=true;window.dispatchEvent(new CustomEvent('stagepulse:admin-ready'));} }; tag.onerror=fail; document.body.appendChild(tag);
})();
