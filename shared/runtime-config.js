...
(function (global) {
  ...
  if (global.location && /^\/admin\//.test(global.location.pathname)) {
    [['link','stylesheet','admin-visual-overhaul.css?v=20260903-1'],['link','stylesheet','patron-center.css?v=20260905-4'],['script','', 'patron-center.js?v=20260906-1'],['script','', 'patron-center-dedupe.js?v=20260905-2'],['script','', 'admin-navigation-state-v2.js?v=20260906-2'],['script','', 'admin-navigation-integrity-v3.js?v=20260906-1'],['script','', 'production-os.js?v=20260906-1'],['link','stylesheet','owner-operating-system.css?v=20260903-3'],['script','', 'owner-operating-system.js?v=20260903-3'],['script','', 'command-center.js?v=20260904-1'],['link','stylesheet','admin-theme-final.css?v=20260904-4'],['link','stylesheet','admin-mobile-final.css?v=20260905-2'],['script','', 'admin-action-colors-v2.js?v=20260905-2'],['script','', 'admin-service-save-repair-v1.js?v=20260905-1']].forEach(function(x){var e=document.createElement(x[0]);if(x[1])e.rel=x[1];if(x[0]==='script')e.src=x[2];else e.href=x[2];e.defer=false;document.head.appendChild(e);});
  }
